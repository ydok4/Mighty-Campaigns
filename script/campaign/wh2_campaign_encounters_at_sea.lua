...
function GenerateEncounterPirate(character, loc, unit)
	...
	-- #### MODIFIED FROM VANILLA FOR MIGHTY CAMPAIGNS
	local agentSubtypeData = _G.MC.ExpandedSeaEncountersController:AssignGeneralForLastEncounter();
	invasion_1:create_general(false, agentSubtypeData.AgentSubTypeKey, agentSubtypeData.ClanName, agentSubtypeData.Forename, "", "");
	-- #### END
